       ...
       <div className={"container py-3"} id={"pageBackground"}>
           <div className="row row-cols-1 row-cols-md-2">
               <div className="col-12 col-md-6 ">
                   ...
                   <address><strong>Royale Chocolate Design</strong><br/>
                       Marienstraße 20<br/>
               ...
               <div className="col-12 col-md-6 ">
                   <h3>Information über das Projekt:</h3>
                   <p> Der Inhalt dieser Webseite ist im Rahmen eines Hochschulprojekts entstanden.
                       Anhand derer keinerlei rechtliche Folge abgeleitet werden kann.
                       Keines der dargestellten Produkte ist erwerbbar!
                   </p>
               </div>
           </div>

           <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom"></div>
